...
echo "  ├── SOUL.md              # AI identity (updated by NEON-SOUL)"
echo "  ├── USER.md              # User profile"
echo "  └── memory/"
echo "      ├── diary/           # Journal entries"
echo "      ├── experiences/     # Event memories"
echo "      ├── goals/           # Aspirations"
echo "      ├── knowledge/       # Learned facts"
echo "      ├── relationships/   # People & connections"
echo "      └── preferences/     # Likes, dislikes"
echo ""
